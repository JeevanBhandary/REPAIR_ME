...
<div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">ADD CATEGORY</h6>
                                ...
                                <button type="submit" name="cat" class="btn btn-primary">ADD</button>
 ...
 <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="row mb-1">
                                    <label for="inputEmail3" class="col col-form-label">Product Name</label>
                                    <div class="col-sm-8">
                            ...
                            <?php }
                             ?>
                                ...
                                <div class="row mb-2">
                                    <label for="inputEmail3" class="col col-form-label">Product Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="inputEmail3" name="pname">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <label for="inputPassword3" class="col col-form-label">Description</label>
                                    <div class="col-sm-8">
                               ...
                               <div class="row mb-2">
                                  <label for="inputEmail3" class="col col-form-label">Quantity</label>
                                   <div class="col-sm-8">
                                        <input type="text" class="form-control" id="inputEmail3" name="quantity">
                                    </div>
                                </div>
                                    <div class="row mb-2">
                                  <label for="inputEmail3" class="col col-form-label">Price</label>
                                   <div class="col-sm-8">
