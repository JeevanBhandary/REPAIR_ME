            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="controller/add_customer.php" method="POST">
                                <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" class="form-control" required name="phone" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="exampleInputPassword1" class="form-label">Customer Address</label>
                                    <input type="text" class="form-control" required name="address" id="exampleInputPassword1">
                                </div>
                                </div>  
                                <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label for="exampleInputPassword1" class="form-label">Brand Name</label>
                                    <input type="text" class="form-control" required name="b_name" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="exampleInputPassword1" class="form-label">Model Name</label>
                                    <input type="text" class="form-control" required name="m_name" id="exampleInputPassword1">
                                </div>
                                </div>
                               <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label for="exampleInputPassword1" class="form-label">Service Name</label>
                                    <input type="text" class="form-control" required name="s_name" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="exampleInputPassword1" class="form-label">Price</label>
                                    <input type="number" class="form-control" required name="s_price" id="exampleInputPassword1">
                                </div>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Vehicle Register Number</label>
                                    <input type="text" class="form-control" required name="v_number" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-primary" required name="add_cus">Add Customer</button>
                            </form>
                        </div>
                    </div>
